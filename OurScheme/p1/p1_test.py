...
def run_tests():
    ...
    exe_path = os.path.join(base_dir, 'p1.exe')
    cpp_path = os.path.join(base_dir, 'p1.cpp')
    ...
    # 取得所有測資檔案
    input_files = glob.glob(os.path.join(input_dir, 'p1-*.txt'))
    input_files.sort()
