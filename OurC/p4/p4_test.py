...
def run_tests():
    ...
    exe_path = os.path.join(base_dir, 'p4.exe')
    cpp_path = os.path.join(base_dir, 'p4.cpp')
    ...
    # 取得所有測資檔案
    input_files = glob.glob(os.path.join(input_dir, 'p4-*.txt'))
    input_files.sort()
